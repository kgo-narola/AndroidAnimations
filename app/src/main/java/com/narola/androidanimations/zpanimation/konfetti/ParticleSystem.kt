package com.alarmmanager.zpanimation.konfetti

import android.graphics.Color
import com.alarmmanager.zpanimation.konfetti.emitters.BurstEmitter
import com.alarmmanager.zpanimation.konfetti.emitters.Emitter
import com.alarmmanager.zpanimation.konfetti.emitters.RenderSystem
import com.fitdigits.app.konfetti.emitters.StreamEmitter
import com.alarmmanager.zpanimation.konfetti.models.ConfettiConfig
import com.alarmmanager.zpanimation.konfetti.models.Shape
import com.alarmmanager.zpanimation.konfetti.models.Size
import com.alarmmanager.zpanimation.konfetti.models.Vector
import com.alarmmanager.zpanimation.konfetti.modules.LocationModule
import com.alarmmanager.zpanimation.konfetti.modules.VelocityModule
import java.util.*
...
class ParticleSystem(private val konfettiView: KonfettiView) {
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith(
            ...
            imports = ["com.alarmmanager.zpanimation.konfetti.ParticleSystem.streamFor"]
        )
    )
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith(
            ...
            imports = ["com.alarmmanager.zpanimation.konfetti.ParticleSystem.streamMaxParticles"]
        )
    )
